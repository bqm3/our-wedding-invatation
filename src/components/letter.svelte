...
<img class="letter-bottom" src={"https://res.cloudinary.com/dftxlzy81/image/upload/v1780138873/bg-full_udkdyv.jpg"} alt="letter bottom" fetchpriority="high"/>
